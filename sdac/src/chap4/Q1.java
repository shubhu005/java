...
//Q1 ---> example of composition aggregation
...
class Emp{
	...
	Hobby hobby; ///Agregation
	public Emp(String name,int id, Address address,Hobby hobby)
	{
		 this.name=name;
		 this.id=id;
	...
	@Override
	public String toString() {
		return "Emp [name=" + name + ", id=" + id + ", address=" + address + ", hobby=" + hobby + "]";
	}
}
...
public class Q1 {
	public static void main(String[] args) {
		...
		Emp emp = new Emp("shubhangi",1,address , hobby);
